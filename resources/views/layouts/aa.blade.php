...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">MFP ACADEMY </span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">FARHAN LELE</a>
        </div>
      </div>
<div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
        ...
        <div class="info">
          <a href="#" class="d-block">FARHAN PABLO</a>
        </div>
      </div>
      <!-- SidebarSearch Form -->
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./index.html" class="nav-link">
                  ...
                  <p>Indovidual Player Stats</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./index2.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Health & Physiotherapy</p>
                </a>
              </li>
                </a>
              </li>
            ...
            <div class="card">
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-striped table-valign-middle">
                  ...
                  <tr>
                    <td>
                      <img src={{ url("lte/dist/img/default-150x150.png") }} alt="Product 1" class="img-circle img-size-32 mr-2">
                      Another Product
                    </td>
                    <td>$29 USD</td>
                    <td>

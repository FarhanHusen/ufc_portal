...
<div class="desc-cards">
  <div class="container row">
      ...
      <div class="card col-lg-3 col-md-12 card-dark0">
          <div class="card-icon pt-4">
              <span class="btn-main main-btn-2"><i class="fas fa-volleyball-ball"></i></span>
          </div>
          <h3>MFP U-10</h3>
      ...
      <div class="card col-lg-3 col-md-12 card-dark1">
          <div class="card-icon pt-4">
              <span class="btn-main main-btn-2"><i class="fas fa-volleyball-ball"></i></span>
          </div>
          <h3>MFP U-12</h3>
      ...
      <div class="card col-lg-3 col-md-12 card-dark2">
          <div class="card-icon pt-4">
              <span class="btn-main main-btn-2"><i class="fas fa-volleyball-ball"></i></span>
          </div>
          <h3>MFP U-14</U-12></h3>
